...
var createDomVisualElement = (Component3, options) => {
  ...
  return isSVG ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component3 !== import_react6.Fragment
  });
};
...
function PopChild({ children, isPresent, anchorX, anchorY, root, pop }) {
  ...
  return (0, import_jsx_runtime2.jsx)(PopChildMeasure, { isPresent, childRef: ref, sizeRef: size, pop, children: pop === false ? children : React2.cloneElement(children, { ref: composedRef }) });
}
...
var DeprecatedLayoutGroupContext = (0, import_react14.createContext)(null);
...
function useForceUpdate() {
  ...
  const [forcedRenderCount, setForcedRenderCount] = (0, import_react16.useState)(0);
  const forceRender = (0, import_react16.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react16.useCallback)(() => frame.postRender(forceRender), [forceRender]);
...
var LayoutGroup = ({ children, id: id3, inherit = true }) => {
  const layoutGroupContext = (0, import_react17.useContext)(LayoutGroupContext);
  const deprecatedLayoutGroupContext = (0, import_react17.useContext)(DeprecatedLayoutGroupContext);
  const [forceRender, key] = useForceUpdate();
  const context = (0, import_react17.useRef)(null);
  ...
  const memoizedContext = (0, import_react17.useMemo)(() => ({ ...context.current, forceRender }), [key]);
  return (0, import_jsx_runtime5.jsx)(LayoutGroupContext.Provider, { value: memoizedContext, children });
};
...
function LazyMotion({ children, features, strict = false }) {
  const [, setIsLoaded] = (0, import_react19.useState)(!isLazyBundle(features));
  const loadedRenderer = (0, import_react19.useRef)(void 0);
...
function useCreateMotionContext(props) {
  const { initial, animate: animate2 } = getCurrentTreeVariants(props, (0, import_react22.useContext)(MotionContext));
  return (0, import_react22.useMemo)(() => ({ initial, animate: animate2 }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate2)]);
}
...
function useMotionRef(visualState, visualElement, externalRef) {
  const externalRefContainer = (0, import_react27.useRef)(externalRef);
  (0, import_react27.useInsertionEffect)(() => {
    externalRefContainer.current = externalRef;
  });
  const refCleanup = (0, import_react27.useRef)(null);
  return (0, import_react27.useCallback)((instance) => {
    var _a;
    if (instance) {
...
function createMotionComponent(Component3, { forwardMotionProps = false, type } = {}, preloadedFeatures, createVisualElement) {
  ...
  function MotionDOMComponent(props, externalRef) {
    ...
    return (0, import_jsx_runtime8.jsxs)(MotionContext.Provider, { value: context, children: [MeasureLayout2 && context.visualElement ? (0, import_jsx_runtime8.jsx)(MeasureLayout2, { visualElement: context.visualElement, ...configAndProps }) : null, useRender(Component3, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, forwardMotionProps, isSVG)] });
  }
...
//# sourceMappingURL=chunk-EYK45C4E.js.map
